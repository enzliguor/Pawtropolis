package pawtropolis.game.domain.animals;

import lombok.NoArgsConstructor;
import lombok.ToString;
import lombok.extern.slf4j.Slf4j;
import pawtropolis.game.domain.animals.domain.AnimalBO;
import pawtropolis.game.domain.animals.domain.AnimalWithTailBO;
import pawtropolis.game.domain.animals.domain.AnimalWithWingsBO;
