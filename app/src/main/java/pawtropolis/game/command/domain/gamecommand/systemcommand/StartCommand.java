...
public class StartCommand extends SystemCommand {
    ...
    @Autowired
    public StartCommand(GameController gameController, GameSessionBO gameSessionBO, MapInitializer mapInitializer, PlayerService playerService, GameSessionService gameSessionService) {
